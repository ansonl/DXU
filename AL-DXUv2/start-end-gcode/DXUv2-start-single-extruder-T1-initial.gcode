...
M104 T1 S195.0 ; Start heating up the initial extruder
G0 Z10 F2400 ; move the platform down to 10mm
M109 T1 S210.0 ; Heat up and wait for not initial extruder
G0 Y150 F7200 ; Move printhead to safe Y location to move right.
G0 X23 Y1.5 F7200 ; 18.0 cannot be nested so 18 is hardcoded
...
; ----
G2 X237.5 Y107.5 Z0.48 I0 J2.5 F18000
M400 ;finish all moves
M104 T1 S210.0 ; Wait for initial nozzle to reach temp if needed.
G0 Y75 F18000
G0 Y65 F7200
G0 X235 Y50 F7200
G92 E0
